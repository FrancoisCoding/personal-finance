  ...
  const handleEmailSignUp = async (e: React.FormEvent) => {
    ...
    if (!hasPasswordRequirementsMet) {
      ...
      toast({
        ...
        description:
          'Please satisfy all password requirements before signing up.',
        variant: 'destructive',
      })
      setIsLoading(false)
      return
    ...
    try {
      ...
      if (!registerResponse.ok) {
        if (Array.isArray(registerPayload?.details)) {
          const normalizedDetails = registerPayload.details.filter(
