...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      'fixed right-4 top-20 z-[100] flex max-h-screen w-[calc(100%-2rem)] ' +
        'flex-col gap-3 sm:w-[420px]',
      className
    )}
    {...props}
  />
...
const toastVariants = cva(
  'group pointer-events-auto relative flex w-full items-center justify-between ' +
    ...
    'transition-all data-[swipe=cancel]:translate-x-0 data-[swipe=end]:' +
    'translate-x-[var(--radix-toast-swipe-end-x)] data-[swipe=move]:' +
    'translate-x-[var(--radix-toast-swipe-move-x)] data-[swipe=move]:' +
    'transition-none data-[state=open]:animate-in data-[state=closed]:' +
    'animate-out data-[swipe=end]:animate-out data-[state=closed]:fade-out-80 ' +
    'data-[state=closed]:slide-out-to-right-full data-[state=open]:' +
    'slide-in-from-top-full',
  {
    variants: {
      variant: {
        default: 'border-border/60 bg-background/95 text-foreground',
        destructive: 'destructive border-red-500/70 bg-red-950/95 text-red-50',
      },
    },
    defaultVariants: {
      variant: 'default',
  ...
  <ToastPrimitives.Action
    ...
    className={cn(
      'inline-flex h-8 shrink-0 items-center justify-center rounded-md border ' +
        ...
        'group-[.destructive]:hover:border-destructive/30 group-[.destructive]:' +
        'hover:bg-destructive group-[.destructive]:hover:text-destructive-foreground ' +
